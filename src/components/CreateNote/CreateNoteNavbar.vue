...
<template>
  ...
  >
    ...
    <div class="flex items-center space-x-4">
      ...
      <router-link to="/myarticle" class="p-2 rounded-md hover:bg-amber-100 whitespace-nowrap text-amber-500">
        回到文章列表
      </router-link> 
      <router-link to="/user" class="p-2 rounded-md hover:bg-amber-100 whitespace-nowrap text-amber-500">
        個人頁面
      </router-link>
    </div>
