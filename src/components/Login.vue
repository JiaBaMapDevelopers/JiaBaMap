<template>
<div  v-if="visible && !user.userData" class="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-screen ml-0 modal-overlay bg-black/50" @click.self="closeModal">
